// ========= DATA DUMMY =========
// kalau belum ada akun tersimpan → buat default
...
function initLoginPage() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    // cek apakah sesuai akun tersimpan
...
// ========= FITUR UBAH EMAIL & PASSWORD =========
function changeCredentials(newEmail, newPassword) {
  if (!newEmail || !newPassword) {
    alert("Email dan password baru tidak boleh kosong.");
    return;
  }
  ...
  alert("Email dan password berhasil diubah!");
}
